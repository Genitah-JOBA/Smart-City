...
public class MessageDTO {
    ...
    public MessageDTO(Long id, String expediteurEmail, String expediteurNom, 
                      String destinataireEmail, String destinataireNom, 
                      String sujet, String contenu, boolean lu, 
                      LocalDateTime dateEnvoi, String type) {
        this.id = id;
